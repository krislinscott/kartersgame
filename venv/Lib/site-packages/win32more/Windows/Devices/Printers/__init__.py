...
class IIppPrintDeviceInstallationResult(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Devices.Printers.IIppPrintDeviceInstallationResult'
    _iid_ = Guid('{fb102fcc-87be-57ff-a086-92272148a256}')
    @winrt_commethod(6)
    def get_Status(self) -> win32more.Windows.Devices.Printers.IppPrintDeviceInstallationStatus: ...
    @winrt_commethod(7)
    def get_InstalledPrinterName(self) -> WinRT_String: ...
    @winrt_commethod(8)
    def get_ExtendedError(self) -> win32more.Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
    InstalledPrinterName = property(get_InstalledPrinterName, None)
    Status = property(get_Status, None)
class IIppPrintDeviceManagerStatics(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Devices.Printers.IIppPrintDeviceManagerStatics'
    _iid_ = Guid('{8f711a45-c1b9-51bb-80c8-38969c81f800}')
    @winrt_commethod(6)
    def CanInstallIppPrintDevice(self) -> Boolean: ...
    @winrt_commethod(7)
    def InstallIppPrintDeviceAsync(self, printerUri: win32more.Windows.Foundation.Uri, printerName: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Printers.IppPrintDeviceInstallationResult]: ...
...
class IppPrintDevice(ComPtr):
    ...
    PrinterUri = property(get_PrinterUri, None)
    UserDefaultPrintTicket = property(get_UserDefaultPrintTicket, put_UserDefaultPrintTicket)
class IppPrintDeviceInstallationResult(ComPtr):
    extends: IInspectable
    default_interface: win32more.Windows.Devices.Printers.IIppPrintDeviceInstallationResult
    _classid_ = 'Windows.Devices.Printers.IppPrintDeviceInstallationResult'
    @winrt_mixinmethod
    def get_Status(self: win32more.Windows.Devices.Printers.IIppPrintDeviceInstallationResult) -> win32more.Windows.Devices.Printers.IppPrintDeviceInstallationStatus: ...
    @winrt_mixinmethod
    def get_InstalledPrinterName(self: win32more.Windows.Devices.Printers.IIppPrintDeviceInstallationResult) -> WinRT_String: ...
    @winrt_mixinmethod
    def get_ExtendedError(self: win32more.Windows.Devices.Printers.IIppPrintDeviceInstallationResult) -> win32more.Windows.Foundation.HResult: ...
    ExtendedError = property(get_ExtendedError, None)
    InstalledPrinterName = property(get_InstalledPrinterName, None)
    Status = property(get_Status, None)
class IppPrintDeviceInstallationStatus(Enum, Int32):
...
class IppPrintDeviceKind(Enum, Int32):
    ...
    FaxOut = 1
    VirtualPrinter = 2
class IppPrintDeviceManager(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.Devices.Printers.IppPrintDeviceManager'
    @winrt_classmethod
    def CanInstallIppPrintDevice(cls: win32more.Windows.Devices.Printers.IIppPrintDeviceManagerStatics) -> Boolean: ...
    @winrt_classmethod
    def InstallIppPrintDeviceAsync(cls: win32more.Windows.Devices.Printers.IIppPrintDeviceManagerStatics, printerUri: win32more.Windows.Foundation.Uri, printerName: WinRT_String) -> win32more.Windows.Foundation.IAsyncOperation[win32more.Windows.Devices.Printers.IppPrintDeviceInstallationResult]: ...
