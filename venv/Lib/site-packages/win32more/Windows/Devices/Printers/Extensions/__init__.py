...
class IPrint3DWorkflowPrintRequestedEventArgs(ComPtr):
    ...
    @winrt_commethod(8)
    def SetSource(self, source: IInspectable) -> Void: ...
    @winrt_commethod(9)
...
class IPrintTaskConfiguration(ComPtr):
    ...
    @winrt_commethod(6)
    def get_PrinterExtensionContext(self) -> IInspectable: ...
    @winrt_commethod(7)
...
class IPrintTaskConfigurationSaveRequest(ComPtr):
    ...
    @winrt_commethod(7)
    def Save(self, printerExtensionContext: IInspectable) -> Void: ...
    @winrt_commethod(8)
...
class Print3DWorkflowPrintRequestedEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def SetSource(self: win32more.Windows.Devices.Printers.Extensions.IPrint3DWorkflowPrintRequestedEventArgs, source: IInspectable) -> Void: ...
    @winrt_mixinmethod
...
class PrintTaskConfiguration(ComPtr):
    ...
    @winrt_mixinmethod
    def get_PrinterExtensionContext(self: win32more.Windows.Devices.Printers.Extensions.IPrintTaskConfiguration) -> IInspectable: ...
    @winrt_mixinmethod
...
class PrintTaskConfigurationSaveRequest(ComPtr):
    ...
    @winrt_mixinmethod
    def Save(self: win32more.Windows.Devices.Printers.Extensions.IPrintTaskConfigurationSaveRequest, printerExtensionContext: IInspectable) -> Void: ...
    @winrt_mixinmethod
