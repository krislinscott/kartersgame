...
class ActionDefinition(ComPtr):
    ...
    @winrt_mixinmethod
    def GetIconFullPath(self: win32more.Windows.AI.Actions.Hosting.IActionDefinition5, qualifierValues: win32more.Windows.Foundation.Collections.PropertySet) -> WinRT_String: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
...
class IActionDefinition4(ComPtr):
    ...
    IsCurrentlyAvailable = property(get_IsCurrentlyAvailable, None)
class IActionDefinition5(ComPtr):
    extends: IInspectable
    _classid_ = 'Windows.AI.Actions.Hosting.IActionDefinition5'
    _iid_ = Guid('{5bea33ef-d325-53a8-8db3-0d771f4d1e54}')
    @winrt_commethod(6)
    def GetIconFullPath(self, qualifierValues: win32more.Windows.Foundation.Collections.PropertySet) -> WinRT_String: ...
