...
class ActionEntityFactory(ComPtr):
    ...
    @winrt_mixinmethod
    def CreateAppointmentEntity(self: win32more.Windows.AI.Actions.IActionEntityFactory6, sourceId: WinRT_String, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, attendees: PassArray[win32more.Windows.AI.Actions.ContactActionEntity]) -> win32more.Windows.AI.Actions.AppointmentActionEntity: ...
    @winrt_mixinmethod
    def Close(self: win32more.Windows.Foundation.IClosable) -> Void: ...
...
class AppointmentActionEntity(ComPtr):
    ...
    @winrt_mixinmethod
    def get_SourceId(self: win32more.Windows.AI.Actions.IAppointmentActionEntity) -> WinRT_String: ...
    @winrt_mixinmethod
...
class IActionEntityFactory6(ComPtr):
    ...
    @winrt_commethod(7)
    def CreateAppointmentEntity(self, sourceId: WinRT_String, appointment: win32more.Windows.ApplicationModel.Appointments.Appointment, attendees: PassArray[win32more.Windows.AI.Actions.ContactActionEntity]) -> win32more.Windows.AI.Actions.AppointmentActionEntity: ...
...
class RemoteFileActionEntity(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Filename(self: win32more.Windows.AI.Actions.IRemoteFileActionEntity2) -> WinRT_String: ...
    @winrt_mixinmethod
    def put_Filename(self: win32more.Windows.AI.Actions.IRemoteFileActionEntity2, value: WinRT_String) -> Void: ...
    @winrt_mixinmethod
