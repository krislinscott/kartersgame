...
WINHTTP_OPTION_QUIC_STATS_V2: UInt32 = 200
WINHTTP_OPTION_QUIC_STREAM_STATS: UInt32 = 202
WINHTTP_OPTION_USE_LOOKASIDE: UInt32 = 203
WINHTTP_OPTION_ERROR_LOG_GUID: UInt32 = 204
WINHTTP_OPTION_ENABLE_FAST_FORWARDING: UInt32 = 205
WINHTTP_OPTION_FAST_FORWARDING_RESPONSE_DATA: UInt32 = 206
WINHTTP_OPTION_UPGRADE_TO_PROTOCOL: UInt32 = 207
WINHTTP_OPTION_CONNECTION_STATS_V2: UInt32 = 208
WINHTTP_OPTION_FAST_FORWARDING_RESPONSE_STATUS: UInt32 = 209
WINHTTP_LAST_OPTION: UInt32 = 209
...
WINHTTP_HANDLE_TYPE_PROTOCOL: UInt32 = 6
...
ICU_INCLUDE_DEFAULT_PORT: UInt32 = 32768
...
ERROR_WINHTTP_FAST_FORWARDING_NOT_SUPPORTED: UInt32 = 12193
WINHTTP_ERROR_LAST: UInt32 = 12193
...
WINHTTP_FEATURE_DISABLE_GLOBAL_POOLING: UInt32 = 76
WINHTTP_FEATURE_GET_PROXY_SETTINGS_EX: UInt32 = 77
WINHTTP_FEATURE_SESSION_SCH_CRED: UInt32 = 78
WINHTTP_FEATURE_QUIC_STATS_V2: UInt32 = 79
WINHTTP_FEATURE_URL_INCLUDE_DEFAULT_PORT: UInt32 = 80
WINHTTP_FEATURE_QUIC_STREAM_STATS: UInt32 = 81
WINHTTP_FEATURE_USE_LOOKASIDE: UInt32 = 82
WINHTTP_FEATURE_ERROR_LOG_GUID: UInt32 = 83
WINHTTP_FEATURE_UPGRADE_TO_PROTOCOL: UInt32 = 88
WINHTTP_FEATURE_CONNECTION_STATS_V2: UInt32 = 89
WINHTTP_FEATURE_FAST_FORWARD_RESPONSE: UInt32 = 90
...
@winfunctype('WINHTTP.dll')
def WinHttpProtocolCompleteUpgrade(hRequest: VoidPtr, dwContext: UIntPtr) -> VoidPtr: ...
@winfunctype('WINHTTP.dll')
def WinHttpProtocolSend(ProtocolHandle: VoidPtr, Flags: UInt64, pvBuffer: VoidPtr, dwBufferLength: UInt32) -> UInt32: ...
@winfunctype('WINHTTP.dll')
def WinHttpProtocolReceive(ProtocolHandle: VoidPtr, Flags: UInt64, pvBuffer: VoidPtr, dwBufferLength: UInt32, pdwBytesRead: POINTER(UInt32)) -> UInt32: ...
@winfunctype('WINHTTP.dll')
...
WinHttpFastForwardingStateInProgress: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_FAST_FORWARDING_STATE = 0
WinHttpFastForwardingStateSucceeded: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_FAST_FORWARDING_STATE = 1
WinHttpFastForwardingStateClientSideFailed: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_FAST_FORWARDING_STATE = 2
WinHttpFastForwardingStateServerSideFailed: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_FAST_FORWARDING_STATE = 3
if ARCH in 'X64,ARM64':
    class WINHTTP_FAST_FORWARDING_STATUS(Structure):
        TransferState: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_FAST_FORWARDING_STATE
        NtStatus: Int32
        dwError: UInt32
...
class WINHTTP_PROTOCOL_ASYNC_RESULT(Structure):
    AsyncResult: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_ASYNC_RESULT
    Operation: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_PROTOCOL_OPERATION
WINHTTP_PROTOCOL_OPERATION = Int32
WINHTTP_PROTOCOL_SEND_OPERATION: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_PROTOCOL_OPERATION = 0
WINHTTP_PROTOCOL_RECEIVE_OPERATION: win32more.Windows.Win32.Networking.WinHttp.WINHTTP_PROTOCOL_OPERATION = 1
@winfunctype_pointer
