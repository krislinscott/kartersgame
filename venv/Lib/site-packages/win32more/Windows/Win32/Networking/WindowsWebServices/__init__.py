...
EXPERIMENTAL_WEBAUTHN_API_VERSION_8: UInt32 = 1008
...
EXPERIMENTAL_WEBAUTHN_CREDENTIAL_DETAILS_VERSION_3: UInt32 = 1003
...
EXPERIMENTAL_WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS_VERSION_8: UInt32 = 1008
...
EXPERIMENTAL_WEBAUTHN_CREDENTIAL_ATTESTATION_VERSION_7: UInt32 = 1007
...
PluginAuthenticatorState_Unknown: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE = 0
PluginAuthenticatorState_Disabled: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE = 1
PluginAuthenticatorState_Enabled: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_PLUGIN_AUTHENTICATOR_STATE = 2
...
class EXPERIMENTAL_WEBAUTHN_CTAPCBOR_GET_ASSERTION_REQUEST(Structure):
    ...
    CredentialList: win32more.Windows.Win32.Networking.WindowsWebServices.WEBAUTHN_CREDENTIAL_LIST
    cbCborExtensionsMap: UInt32
    pbCborExtensionsMap: POINTER(Byte)
    pAuthenticatorOptions: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_CTAPCBOR_AUTHENTICATOR_OPTIONS)
    fEmptyPinAuth: win32more.Windows.Win32.Foundation.BOOL
    cbPinAuth: UInt32
    pbPinAuth: POINTER(Byte)
    pHmacSaltExtension: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_CTAPCBOR_HMAC_SALT_EXTENSION)
...
class EXPERIMENTAL_WEBAUTHN_CTAPCBOR_GET_ASSERTION_RESPONSE(Structure):
    WebAuthNAssertion: win32more.Windows.Win32.Networking.WindowsWebServices.WEBAUTHN_ASSERTION
...
class EXPERIMENTAL_WEBAUTHN_CTAPCBOR_HMAC_SALT_EXTENSION(Structure):
    dwVersion: UInt32
    pKeyAgreement: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_CTAPCBOR_ECC_PUBLIC_KEY)
...
class EXPERIMENTAL_WEBAUTHN_CTAPCBOR_MAKE_CREDENTIAL_REQUEST(Structure):
    ...
    pUserInformation: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.WEBAUTHN_USER_ENTITY_INFORMATION)
    WebAuthNCredentialParameters: win32more.Windows.Win32.Networking.WindowsWebServices.WEBAUTHN_COSE_CREDENTIAL_PARAMETERS
    CredentialList: win32more.Windows.Win32.Networking.WindowsWebServices.WEBAUTHN_CREDENTIAL_LIST
    cbCborExtensionsMap: UInt32
    pbCborExtensionsMap: POINTER(Byte)
    pAuthenticatorOptions: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_CTAPCBOR_AUTHENTICATOR_OPTIONS)
    ...
    pHmacSecretMcExtension: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_CTAPCBOR_HMAC_SALT_EXTENSION)
    lPrfExt: Int32
    cbHmacSecretSaltValues: UInt32
    pbHmacSecretSaltValues: POINTER(Byte)
...
class EXPERIMENTAL_WEBAUTHN_PLUGIN_ADD_AUTHENTICATOR_OPTIONS(Structure):
    ...
    cbPluginIdKey: UInt32
    pbPluginIdKey: POINTER(Byte)
...
class EXPERIMENTAL_WEBAUTHN_PLUGIN_CREDENTIAL_DETAILS_LIST(Structure):
    ...
    pCredentialDetails: POINTER(POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_PLUGIN_CREDENTIAL_DETAILS))
    cbNonce: UInt32
...
class EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV(Structure):
    ...
    type: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE
    pwszUsername: win32more.Windows.Win32.Foundation.PWSTR
    pwszContext: win32more.Windows.Win32.Foundation.PWSTR
EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = Int32
PerformUv: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = 1
GetUvCount: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = 2
GetPubKey: win32more.Windows.Win32.Networking.WindowsWebServices.EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_OPERATION_TYPE = 3
class EXPERIMENTAL_WEBAUTHN_PLUGIN_PERFORM_UV_RESPONSE(Structure):
    cbResponse: UInt32
    pbResponse: POINTER(Byte)
class EXPERIMENTAL_WEBAUTHN_PLUGIN_REMOVE_AUTHENTICATOR_OPTIONS(Structure):
    pwszPluginClsId: win32more.Windows.Win32.Foundation.PWSTR
    cbNonce: UInt32
    pbNonce: POINTER(Byte)
    cbSignature: UInt32
...
class WEBAUTHN_AUTHENTICATOR_MAKE_CREDENTIAL_OPTIONS(Structure):
    ...
    cbJsonExt: UInt32
    pbJsonExt: POINTER(Byte)
    EXPERIMENTAL_pPRFGlobalEval: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.WEBAUTHN_HMAC_SECRET_SALT)
...
class WEBAUTHN_CREDENTIAL_ATTESTATION(Structure):
    ...
    cbUnsignedExtensionOutputs: UInt32
    pbUnsignedExtensionOutputs: POINTER(Byte)
    EXPERIMENTAL_pHmacSecret: POINTER(win32more.Windows.Win32.Networking.WindowsWebServices.WEBAUTHN_HMAC_SECRET_SALT)
class WEBAUTHN_CREDENTIAL_DETAILS(Structure):
    ...
    EXPERIMENTAL_pwszAuthenticatorName: win32more.Windows.Win32.Foundation.PWSTR
    EXPERIMENTAL_cbAuthenticatorLogo: UInt32
    EXPERIMENTAL_pbAuthenticatorLogo: POINTER(Byte)
