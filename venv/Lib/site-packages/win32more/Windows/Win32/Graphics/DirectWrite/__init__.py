...
class DWRITE_CLUSTER_METRICS(Structure):
    width: Single
    length: UInt16
    canWrapLineAfter: Annotated[UInt16, NativeBitfieldAttribute(1)]
    isWhitespace: Annotated[UInt16, NativeBitfieldAttribute(1)]
    isNewline: Annotated[UInt16, NativeBitfieldAttribute(1)]
    isSoftHyphen: Annotated[UInt16, NativeBitfieldAttribute(1)]
    isRightToLeft: Annotated[UInt16, NativeBitfieldAttribute(1)]
    padding: Annotated[UInt16, NativeBitfieldAttribute(11)]
...
class DWRITE_JUSTIFICATION_OPPORTUNITY(Structure):
    ...
    expansionPriority: Annotated[UInt32, NativeBitfieldAttribute(8)]
    compressionPriority: Annotated[UInt32, NativeBitfieldAttribute(8)]
    allowResidualExpansion: Annotated[UInt32, NativeBitfieldAttribute(1)]
    allowResidualCompression: Annotated[UInt32, NativeBitfieldAttribute(1)]
    applyToLeadingEdge: Annotated[UInt32, NativeBitfieldAttribute(1)]
    applyToTrailingEdge: Annotated[UInt32, NativeBitfieldAttribute(1)]
    reserved: Annotated[UInt32, NativeBitfieldAttribute(12)]
class DWRITE_LINE_BREAKPOINT(Structure):
    breakConditionBefore: Annotated[Byte, NativeBitfieldAttribute(2)]
    breakConditionAfter: Annotated[Byte, NativeBitfieldAttribute(2)]
    isWhitespace: Annotated[Byte, NativeBitfieldAttribute(1)]
    isSoftHyphen: Annotated[Byte, NativeBitfieldAttribute(1)]
    padding: Annotated[Byte, NativeBitfieldAttribute(2)]
...
class DWRITE_SCRIPT_PROPERTIES(Structure):
    ...
    restrictCaretToClusters: Annotated[UInt32, NativeBitfieldAttribute(1)]
    usesWordDividers: Annotated[UInt32, NativeBitfieldAttribute(1)]
    isDiscreteWriting: Annotated[UInt32, NativeBitfieldAttribute(1)]
    isBlockWriting: Annotated[UInt32, NativeBitfieldAttribute(1)]
    isDistributedWithinCluster: Annotated[UInt32, NativeBitfieldAttribute(1)]
    isConnectedWriting: Annotated[UInt32, NativeBitfieldAttribute(1)]
    isCursiveWriting: Annotated[UInt32, NativeBitfieldAttribute(1)]
...
class DWRITE_SHAPING_GLYPH_PROPERTIES(Structure):
    justification: Annotated[UInt16, NativeBitfieldAttribute(4)]
    isClusterStart: Annotated[UInt16, NativeBitfieldAttribute(1)]
    isDiacritic: Annotated[UInt16, NativeBitfieldAttribute(1)]
    isZeroWidthSpace: Annotated[UInt16, NativeBitfieldAttribute(1)]
    reserved: Annotated[UInt16, NativeBitfieldAttribute(9)]
class DWRITE_SHAPING_TEXT_PROPERTIES(Structure):
    isShapedAlone: Annotated[UInt16, NativeBitfieldAttribute(1)]
    reserved1: Annotated[UInt16, NativeBitfieldAttribute(1)]
    canBreakShapingAfter: Annotated[UInt16, NativeBitfieldAttribute(1)]
