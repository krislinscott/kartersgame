...
DXC_CP_UTF32: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP = 12000
DXC_CP_WIDE: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP = 1200
DXC_OUT_KIND = Int32
...
DXC_OUT_REMARKS: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_OUT_KIND = 11
DXC_OUT_TIME_REPORT: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_OUT_KIND = 12
DXC_OUT_TIME_TRACE: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_OUT_KIND = 13
DXC_OUT_LAST: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_OUT_KIND = 13
DXC_OUT_NUM_ENUMS: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_OUT_KIND = 14
...
class IDxcLibrary(ComPtr):
    ...
    @commethod(12)
    def GetBlobAsWide(self, pBlob: win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob, pBlobEncoding: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
...
class IDxcPdbUtils2(ComPtr):
    extends: win32more.Windows.Win32.System.Com.IUnknown
    _iid_ = Guid('{4315d938-f369-4f93-95a2-252017cc3807}')
    @commethod(3)
    def Load(self, pPdbOrDxil: win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def GetSourceCount(self, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    ...
    def GetSource(self, uIndex: UInt32, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def GetSourceName(self, uIndex: UInt32, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def GetLibraryPDBCount(self, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    def GetLibraryPDB(self, uIndex: UInt32, ppOutPdbUtils: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcPdbUtils2), ppLibraryName: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(9)
    def GetFlagCount(self, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(10)
    def GetFlag(self, uIndex: UInt32, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetArgCount(self, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
    def GetArg(self, uIndex: UInt32, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(13)
    def GetArgPairCount(self, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(14)
    def GetArgPair(self, uIndex: UInt32, ppName: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16), ppValue: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(15)
    def GetDefineCount(self, pCount: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(16)
    def GetDefine(self, uIndex: UInt32, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(17)
    def GetTargetProfile(self, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(18)
    def GetEntryPoint(self, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(19)
    def GetMainFileName(self, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(20)
    def GetHash(self, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(21)
    def GetName(self, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(22)
    def GetVersionInfo(self, ppVersionInfo: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcVersionInfo)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(23)
    def GetCustomToolchainID(self, pID: POINTER(UInt32)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(24)
    def GetCustomToolchainData(self, ppBlob: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(25)
    def GetWholeDxil(self, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(26)
    def IsFullPDB(self) -> win32more.Windows.Win32.Foundation.BOOL: ...
    @commethod(27)
    def IsPDBRef(self) -> win32more.Windows.Win32.Foundation.BOOL: ...
...
class IDxcUtils(ComPtr):
    ...
    def CreateBlobFromBlob(self, pBlob: win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob, offset: UInt32, length: UInt32, ppResult: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(4)
    def CreateBlobFromPinned(self, pData: VoidPtr, size: UInt32, codePage: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, ppBlobEncoding: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(5)
    def MoveToBlob(self, pData: VoidPtr, pIMalloc: win32more.Windows.Win32.System.Com.IMalloc, size: UInt32, codePage: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, ppBlobEncoding: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(6)
    def CreateBlob(self, pData: VoidPtr, size: UInt32, codePage: win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP, ppBlobEncoding: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(7)
    def LoadFile(self, pFileName: win32more.Windows.Win32.Foundation.PWSTR, pCodePage: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.DXC_CP), ppBlobEncoding: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobEncoding)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(8)
    ...
    @commethod(10)
    def GetBlobAsUtf8(self, pBlob: win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob, ppBlobEncoding: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf8)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(11)
    def GetBlobAsWide(self, pBlob: win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlob, ppBlobEncoding: POINTER(win32more.Windows.Win32.Graphics.Direct3D.Dxc.IDxcBlobUtf16)) -> win32more.Windows.Win32.Foundation.HRESULT: ...
    @commethod(12)
