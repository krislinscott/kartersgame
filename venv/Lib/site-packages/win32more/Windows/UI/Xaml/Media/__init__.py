...
class FontFamily(ComPtr, metaclass=_FontFamily_Meta_):
    ...
    def __init__(self, *args, **kwargs):
        if kwargs:
            ...
            raise ValueError('no matched constructor')
    @winrt_factorymethod
    def CreateInstanceWithName(cls: win32more.Windows.UI.Xaml.Media.IFontFamilyFactory, familyName: WinRT_String, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Windows.UI.Xaml.Media.FontFamily: ...
    @winrt_mixinmethod
...
class IFontFamilyFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstanceWithName(self, familyName: WinRT_String, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Windows.UI.Xaml.Media.FontFamily: ...
