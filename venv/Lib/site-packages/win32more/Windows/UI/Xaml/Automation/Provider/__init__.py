...
class ICustomNavigationProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def NavigateCustom(self, direction: win32more.Windows.UI.Xaml.Automation.Peers.AutomationNavigationDirection) -> IInspectable: ...
...
class IItemContainerProvider(ComPtr):
    ...
    @winrt_commethod(6)
    def FindItemByProperty(self, startAfter: win32more.Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple, automationProperty: win32more.Windows.UI.Xaml.Automation.AutomationProperty, value: IInspectable) -> win32more.Windows.UI.Xaml.Automation.Provider.IRawElementProviderSimple: ...
...
class ITextRangeProvider(ComPtr):
    ...
    @winrt_commethod(10)
    def FindAttribute(self, attributeId: Int32, value: IInspectable, backward: Boolean) -> win32more.Windows.UI.Xaml.Automation.Provider.ITextRangeProvider: ...
    @winrt_commethod(11)
