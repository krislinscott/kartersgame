...
class FrameNavigationOptions(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.UI.Xaml.Navigation.IFrameNavigationOptionsFactory, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Windows.UI.Xaml.Navigation.FrameNavigationOptions: ...
    @winrt_mixinmethod
...
class IFrameNavigationOptionsFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Windows.UI.Xaml.Navigation.FrameNavigationOptions: ...
...
class IPageStackEntryFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, sourcePageType: win32more.Windows.UI.Xaml.Interop.TypeName, parameter: IInspectable, navigationTransitionInfo: win32more.Windows.UI.Xaml.Media.Animation.NavigationTransitionInfo) -> win32more.Windows.UI.Xaml.Navigation.PageStackEntry: ...
...
class LoadCompletedEventHandler(MulticastDelegate):
    ...
    @winrt_commethod(3)
    def Invoke(self, sender: IInspectable, e: win32more.Windows.UI.Xaml.Navigation.NavigationEventArgs) -> Void: ...
...
class NavigatingCancelEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Parameter(self: win32more.Windows.UI.Xaml.Navigation.INavigatingCancelEventArgs2) -> IInspectable: ...
    @winrt_mixinmethod
...
class NavigationEventArgs(ComPtr):
    ...
    @winrt_mixinmethod
    def get_Content(self: win32more.Windows.UI.Xaml.Navigation.INavigationEventArgs) -> IInspectable: ...
    @winrt_mixinmethod
    def get_Parameter(self: win32more.Windows.UI.Xaml.Navigation.INavigationEventArgs) -> IInspectable: ...
    @winrt_mixinmethod
...
class PageStackEntry(ComPtr, metaclass=_PageStackEntry_Meta_):
    ...
    @winrt_mixinmethod
    def get_Parameter(self: win32more.Windows.UI.Xaml.Navigation.IPageStackEntry) -> IInspectable: ...
    @winrt_mixinmethod
