...
class IComponentConnector2(ComPtr):
    ...
    @winrt_commethod(6)
    def GetBindingConnector(self, connectionId: Int32, target: IInspectable) -> win32more.Windows.UI.Xaml.Markup.IComponentConnector: ...
...
class IMarkupExtensionFactory(ComPtr):
    ...
    @winrt_commethod(6)
    def CreateInstance(self, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Windows.UI.Xaml.Markup.MarkupExtension: ...
...
class IXamlBindingHelperStatics(ComPtr):
    ...
    @winrt_commethod(12)
    def SetPropertyFromString(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: WinRT_String) -> Void: ...
    @winrt_commethod(13)
    def SetPropertyFromBoolean(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Boolean) -> Void: ...
    @winrt_commethod(14)
    def SetPropertyFromChar16(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Char) -> Void: ...
    @winrt_commethod(15)
    def SetPropertyFromDateTime(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.DateTime) -> Void: ...
    @winrt_commethod(16)
    def SetPropertyFromDouble(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Double) -> Void: ...
    @winrt_commethod(17)
    def SetPropertyFromInt32(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Int32) -> Void: ...
    @winrt_commethod(18)
    def SetPropertyFromUInt32(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: UInt32) -> Void: ...
    @winrt_commethod(19)
    def SetPropertyFromInt64(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Int64) -> Void: ...
    @winrt_commethod(20)
    def SetPropertyFromUInt64(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: UInt64) -> Void: ...
    @winrt_commethod(21)
    def SetPropertyFromSingle(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Single) -> Void: ...
    @winrt_commethod(22)
    def SetPropertyFromPoint(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.Point) -> Void: ...
    @winrt_commethod(23)
    def SetPropertyFromRect(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.Rect) -> Void: ...
    @winrt_commethod(24)
    def SetPropertyFromSize(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.Size) -> Void: ...
    @winrt_commethod(25)
    def SetPropertyFromTimeSpan(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_commethod(26)
    def SetPropertyFromByte(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Byte) -> Void: ...
    @winrt_commethod(27)
    def SetPropertyFromUri(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.Uri) -> Void: ...
    @winrt_commethod(28)
    def SetPropertyFromObject(self, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: IInspectable) -> Void: ...
...
class MarkupExtension(ComPtr):
    ...
    @winrt_factorymethod
    def CreateInstance(cls: win32more.Windows.UI.Xaml.Markup.IMarkupExtensionFactory, baseInterface: IInspectable, innerInterface: POINTER(IInspectable)) -> win32more.Windows.UI.Xaml.Markup.MarkupExtension: ...
    @winrt_mixinmethod
    def ProvideValue(self: win32more.Windows.UI.Xaml.Markup.IMarkupExtensionOverrides) -> IInspectable: ...
...
class XamlBindingHelper(ComPtr, metaclass=_XamlBindingHelper_Meta_):
    ...
    @winrt_classmethod
    def ConvertValue(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, type: win32more.Windows.UI.Xaml.Interop.TypeName, value: IInspectable) -> IInspectable: ...
    @winrt_classmethod
    def SetPropertyFromString(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: WinRT_String) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromBoolean(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Boolean) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromChar16(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Char) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromDateTime(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.DateTime) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromDouble(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Double) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromInt32(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Int32) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromUInt32(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: UInt32) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromInt64(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Int64) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromUInt64(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: UInt64) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromSingle(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Single) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromPoint(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.Point) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromRect(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.Rect) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromSize(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.Size) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromTimeSpan(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.TimeSpan) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromByte(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: Byte) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromUri(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: win32more.Windows.Foundation.Uri) -> Void: ...
    @winrt_classmethod
    def SetPropertyFromObject(cls: win32more.Windows.UI.Xaml.Markup.IXamlBindingHelperStatics, dependencyObject: IInspectable, propertyToSet: win32more.Windows.UI.Xaml.DependencyProperty, value: IInspectable) -> Void: ...
...
class XamlReader(ComPtr):
    ...
    @winrt_classmethod
    def Load(cls: win32more.Windows.UI.Xaml.Markup.IXamlReaderStatics, xaml: WinRT_String) -> IInspectable: ...
    @winrt_classmethod
    def LoadWithInitialTemplateValidation(cls: win32more.Windows.UI.Xaml.Markup.IXamlReaderStatics, xaml: WinRT_String) -> IInspectable: ...
