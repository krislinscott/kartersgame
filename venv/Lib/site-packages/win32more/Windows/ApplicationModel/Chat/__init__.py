...
class ChatMessageTransportConfiguration(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ExtendedProperties(self: win32more.Windows.ApplicationModel.Chat.IChatMessageTransportConfiguration) -> win32more.Windows.Foundation.Collections.IMapView[WinRT_String, IInspectable]: ...
...
class IRcsManagerStatics2(ComPtr):
    ...
    @winrt_commethod(6)
    def add_TransportListChanged(self, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(7)
...
class RcsManager(ComPtr):
    ...
    @winrt_classmethod
    def add_TransportListChanged(cls: win32more.Windows.ApplicationModel.Chat.IRcsManagerStatics2, handler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
...
class RcsTransport(ComPtr):
    ...
    @winrt_mixinmethod
    def get_ExtendedProperties(self: win32more.Windows.ApplicationModel.Chat.IRcsTransport) -> win32more.Windows.Foundation.Collections.IMapView[WinRT_String, IInspectable]: ...
    @winrt_mixinmethod
