...
class ICameraSettingsActivatedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_VideoDeviceController(self) -> IInspectable: ...
    @winrt_commethod(7)
    def get_VideoDeviceExtension(self) -> IInspectable: ...
    VideoDeviceController = property(get_VideoDeviceController, None)
    VideoDeviceExtension = property(get_VideoDeviceExtension, None)
...
class ILockScreenActivatedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_Info(self) -> IInspectable: ...
...
class IRestrictedLaunchActivatedEventArgs(ComPtr):
    ...
    @winrt_commethod(6)
    def get_SharedContext(self) -> IInspectable: ...
...
class ISplashScreen(ComPtr):
    ...
    @winrt_commethod(7)
    def add_Dismissed(self, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.Activation.SplashScreen, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(8)
...
class SplashScreen(ComPtr):
    ...
    @winrt_mixinmethod
    def add_Dismissed(self: win32more.Windows.ApplicationModel.Activation.ISplashScreen, handler: win32more.Windows.Foundation.TypedEventHandler[win32more.Windows.ApplicationModel.Activation.SplashScreen, IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_mixinmethod
