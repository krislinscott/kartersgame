...
class IUserInformationStatics(ComPtr):
    ...
    @winrt_commethod(13)
    def add_AccountPictureChanged(self, changeHandler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_commethod(14)
...
class UserInformation(ComPtr, metaclass=_UserInformation_Meta_):
    ...
    @winrt_classmethod
    def add_AccountPictureChanged(cls: win32more.Windows.System.UserProfile.IUserInformationStatics, changeHandler: win32more.Windows.Foundation.EventHandler[IInspectable]) -> win32more.Windows.Foundation.EventRegistrationToken: ...
    @winrt_classmethod
